...
export function InputBar({ value, busy, suggestions, selectedSuggestionIdx }: InputBarProps) {
  const [cursorOn, setCursorOn] = useState(true);

  useEffect(() => {
    if (busy) { setCursorOn(false); return; }
  ...
  return (
    <Box flexDirection="column">
      {hasSuggestions && (
        <SuggestionsOverlay suggestions={suggestions} selectedIdx={selectedSuggestionIdx} />
      )}
