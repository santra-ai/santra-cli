  ...
  return (
    <section style={{ padding: "4rem 1.5rem" }}>
      <div className="container-sm">
        ...
        >
          This comparison reflects our best understanding as of April 2026. If
            ...
            <tbody>
              {ROWS.map((row, i) => (
                ...
                >
                  ...
                  <td
                    style={{ padding: "0.75rem 1rem", color: "var(--text-2)" }}
                  >
          ...
          {CHOOSE.map((item, i) => (
            <div
              ...
              style={{
                ...
                padding: "1.25rem 0",
                borderBottom:
                  i < CHOOSE.length - 1 ? "1px solid var(--border)" : "none",
              }}
        ...
        >
          ...
          <Link href={LINKS.providers} className="btn btn-outline">
            Browse providers
          </Link>
        </div>
      </div>
...
function Status({ v }: { v: boolean | "partial" }) {
  ...
  if (v === "partial")
    return <span style={{ color: "var(--orange)", fontWeight: 700 }}>◑ </span>;
...
const ROWS: {
...
}[] = [
  {
    ...
    santra: "Anthropic, OpenAI, NIM, any OpenAI-compat API",
  ...
  },
  {
    ...
    santra: "Yes — set one env var, direct to provider",
    claude: "Subscription; no external key support",
    s: true,
    c: false,
  },
  {
    feature: "On-prem / air-gapped",
    santra: "Via Nvidia NIM or any self-hosted server",
  ...
  {
    feature: "npm install",
    santra: "npm install -g santra, no account",
    claude: "Separate installer, account required",
    s: true,
    c: "partial",
  },
  {
    feature: "Multi-agent swarm",
    santra: "Orchestrator spawns specialists dynamically",
    claude: "Single agent with tool use",
    s: true,
    c: "partial",
  },
  {
    feature: "23 built-in tools",
    santra: "File ops, search, shell, web, agent control",
    claude: "Comparable tool set",
    s: true,
    c: true,
  },
  {
    feature: "Change approval",
    santra: "Diff shown, user approves before apply",
    claude: "Yes — similar approval flow",
    s: true,
    c: true,
  },
  {
    feature: "Agentic code quality",
    santra: "Strong — multi-agent review loop",
    claude: "Excellent — polished, battle-tested",
    s: "partial",
    c: true,
  },
  {
  ...
  },
  {
    feature: "MCP servers",
    santra: "Not yet",
    claude: "Full MCP ecosystem",
    s: false,
    c: true,
  },
  {
    feature: "Scriptable / CI",
    santra: "Standard process — pipe stdin/stdout",
    claude: "Limited non-interactive support",
    s: true,
    c: "partial",
  },
];
